# ISA 3: correlation coefficients and working with normal distributions {#sec-ISACh3}
...
This allows us to answer our question: _there is a `{r} round((pnorm(target_income ,mean = mean_income, sd = sd_income, lower.tail = FALSE))*100,2)`% chance of randomly selecting an individual with an income above 1,700 EUR per week from the population of new Dutch graduates_
...
* Calculation and interpretation of pearson's $r$
* Using scatterplots to support our interpretation of $r$
* Transforming datapoints into z-scores and using these to make statements about the probability of selecting values where the underlying distribution characteristics are known