...
(Along with these, we can see that four countries had [`NA` values](2_r_firstdata.qmd#nte-pipe) for this variable. We need to bear this in mind as we go further, because R will try to get answers out of `NA` entries where no answers are to be had.) 
