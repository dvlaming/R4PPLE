...
```{r}
x<-table(haven::as_factor(wd$fhp_status5),haven::as_factor(wd$region),2)
...
wd %>% 
  ...
  tibble::print(., n = 25) # use this code from the `tibble` package (loaded with `tidyverse`) to show more than the default 10 rows of the data after the selection 
